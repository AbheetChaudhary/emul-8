...
pub enum Inst {
    NOP, ACI, ADC, ADD, ADI, ANA, ANI, CALL, CC, CM, CMA, CMC, CMP, CNC, CNZ, CP, CPE, CPI, CPO,
    CZ, DAA, DAD, DCR, DCX, DI, EI, HLT, IN, INR, INX, JC, JM, JMP, JNC, JNZ, JP, JPE, JPO, JZ,
    LDA, LDAX, LHLD, LXI, MOV, MVI, ORA, ORI, OUT, PCHL, POP, PUSH, RAL, RAR, RC, RET, RIM, RLC,
